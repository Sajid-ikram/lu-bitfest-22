        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                role == "Student" ? Colors.black : Colors.grey,
                            borderRadius: BorderRadius.circular(10.sp),
                          ),
                          child: Center(
                              child: Text(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                role == "Teacher" ? Colors.black : Colors.grey,
                            borderRadius: BorderRadius.circular(10.sp),
                          ),
                          child: Center(
                              child: Text(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            style: TextStyle(
                              color:
                                  role == "Staff" ? Colors.white : Colors.black,
                            ),
                          )),
                        ),
                      ),
              ...
              switchPageButton("Already Have An Account", "LogIn", context),
              const SizedBox(height: 20),
              SizedBox(
                      ...
                      await FirebaseAuth.instance.verifyPhoneNumber(
                        ...
                        codeSent: (String verificationId, int? resendToken) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  MyVerify(pageName: "registration"),
                            ),
                          );
                        },
